# types/strategy.ts Content Specification

**File ID:** E1  
**File Path:** `src/types/strategy.ts`  
**Status:** CREATE  
**Priority:** P0
...
Defines all TypeScript types and interfaces for the 7-tier strategy system. This is the central type definition file that ensures type safety across the entire FallbackChain architecture - from recording (FallbackChainGenerator) through storage (EvidenceBuffer) to playback (DecisionEngine). All strategy-related types are consolidated here to prevent circular dependencies and ensure consistent typing across the codebase.
...
### Used By (exports to)
- `../contentScript/RecordingOrchestrator`: FallbackChain, CapturedAction
- `../contentScript/layers/*`: Strategy metadata types
- `../background/services/DecisionEngine`: All strategy types
- `../background/services/FallbackChainGenerator`: StrategyCandidate, LocatorStrategy
- `../background/services/StrategyScorer`: StrategyType, scoring types
- `../background/services/strategies/*`: StrategyEvaluationResult
- `../background/services/TelemetryLogger`: StrategyType, evaluation types
- `../pages/Recorder.tsx`: FallbackChain display
- `../pages/TestRunner.tsx`: Playback types
